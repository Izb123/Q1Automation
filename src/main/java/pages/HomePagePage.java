...
public class HomePagePage extends BasePage {
	...
	public void addItems() {
		...
		FIRST_ITEM.sendKeys("Kigali" + generateRandomNumber(99));
		ADD_BUTTON.click();
		SECOND_ITEM.sendKeys("Butare"+ generateRandomNumber(99));
		ADD_BUTTON.click();
		THIRD_ITEM.sendKeys("Rusizi"+ generateRandomNumber(99));
		ADD_BUTTON.click();
	}
